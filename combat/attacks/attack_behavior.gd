...
func setup(new_attacker: CombatUnit, new_target: CombatUnit, new_attack_state: AttackState, new_combat_system: CombatSystem) -> void:
	...
	if is_instance_valid(target):
		initial_target_position = target.global_position
